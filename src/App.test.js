...
// renders the App and makes successful API call
...
// renders App component after data is passed in
test("renders after data is passed through", async () => {
  mockFetchShow.mockResolvedValueOnce(seasonsData);
  ...
  expect(getByText(/the body/i)).toBeInTheDocument();
});

// re-renders Episode component after data is passed in
